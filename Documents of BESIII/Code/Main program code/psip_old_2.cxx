...
StatusCode psip::execute() // 执行
{
    ...
    HepLorentzVector p4c[4], ptk[6], p_pmpip[2], p_pppim[2]; //定义洛伦兹矢量
    // p4c顺序：1.Lambda 2.Lambdabar 3.gamma1 4.gamma2
    // ptk(未过4C)顺序：1.pp 2.pm 3.pip 4.pim 5.gamma1-emc 6.gamma2-emc
    ...
    if (m_test4k4C == 1)
    {
        ...
        wtkLam1.push_back(temp_wtkLam1[champion]);
        wtkLam2.push_back(temp_wtkLam2[champion]);
        ...
        m_mix7_bk1 = (ptk[2] + ptk[3] + ptk[4] + ptk[5]).mag(); // pip & pim & pi0
