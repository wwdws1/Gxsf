...
void MLambdabarpi0()
{
	...
	TCanvas *c1 = new TCanvas("c1", "M_Lambdabarpi0.eps", 800, 600);
	...
	ch2->Add("../../0912MCmix/root/0912INMC4_pi0.root");

	TChain *ch3 = new TChain("trkRes");
	ch3->Add("../root/0912data4_pi0.root");
	...
	h1a->GetXaxis()->SetTitle("M(#bar{#Lambda}#pi^{0}) (GeV/c^{2})");
	...
	lg1->AddEntry(h1c, "09 & 12 data", "pl");
	lg1->SetFillColor(0);
	lg1->SetTextFont(42);
