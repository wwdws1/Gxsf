{
    TFile *f1 = new TFile("../../topology/MCGenTopo_ta.root");
    TFile *newfile = new TFile("../root/INMC4_eta_gammaLambdaSigmaBKG.root", "recreate");
    //======================= for mu infor ==================================
	...
	*/
    ...
    chain->SetBranchAddress("iDcyTr", &iDcyTr);
