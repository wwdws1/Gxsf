...
void Mpippimpi0()
{
	...
	ch1->Draw("orig_mpippim2gamma>>h0a");
	ch2->Draw("orig_mpippim2gamma>>h0b");
	...
	h0a->GetXaxis()->SetTitle("M(#pi^{+}#pi^{-}#pi^{0}) GeV/c^{2}");
	...
	TLegend *lg1 = new TLegend(0.62, 0.68, 0.89, 0.88);
