...
void fdc_mc()
{
    //TFile *f1 = new TFile("E:/Work/IHEPBOX/root/0912MCmix/pi0MC5_NoGam_test.root");
    TFile *f1 = new TFile("E:/Work/IHEPBOX/root/0912MCmix/etaMC5_fdc.root");
    //======================= for mu infor ==================================
	...
	*/
    ...
    ofstream *mcfdc = NULL;
    mcfdc = new ofstream;
    //mcfdc->open("../fdc_pi0.mc");
    mcfdc->open("../../fdc/fdc_eta.mc");
    ...
    for (int i = 0; i < nevent; i++)
    {
        ...
        {
            *mcfdc << trk_px[i1] << " " << trk_py[i1] << " " << trk_pz[i1] << " " << trk_en[i1] << endl;
        }

        *mcfdc << (emc_px[0] + emc_px[1]) << " " << (emc_py[0] + emc_py[1]) << " " << (emc_pz[0] + emc_pz[1]) << " " << (emc_en[0] + emc_en[1]) << endl;
    }
