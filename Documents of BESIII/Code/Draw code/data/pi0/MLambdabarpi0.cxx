...
void MLambdabarpi0()
{
	...
	TCanvas *c1 = new TCanvas("c1", "M_Lambdabarpi0.eps", 250, 50, 800, 600);
	...
	ch5->Draw("orig_m2gammalambdabar>>h1e");
	ch6->Draw("orig_m2gammalambdabar>>h1f");
	ch7->Draw("orig_m2gammalambdabar>>h1g");
