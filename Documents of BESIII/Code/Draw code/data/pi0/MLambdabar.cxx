...
void MLambdabar()
{
	...
	ch1->Add("E:/Work/IHEPBOX/root/0912MCmix/pi0MC5_NoLamb.root");
	//ch1->Add("../root/MC_eta.root");

	//TChain *ch2 = new TChain("trkRes");
	//ch2->Add("../../0912MCmix/root/INMC.root");

	TChain *ch3 = new TChain("trkRes");
	ch3->Add("E:/Work/IHEPBOX/root/0912data/data5_pi0_NoLamb.root");
	...
	*/
	...
	h1a->GetXaxis()->SetTitle("M(#bar{p}#pi^{+}) (GeV/c^{2})");
	...
	TArrow *x1 = new TArrow(1.111, 0, 1.111, 16, 0.03, "<");
	x1->SetLineColor(2);
	x1->SetLineWidth(1);
	x1->Draw();

	TArrow *x2 = new TArrow(1.121, 0, 1.121, 16, 0.03, "<");
	x2->SetLineColor(2);
	x2->SetLineWidth(1);
	x2->Draw();
