...
void Mpmpi0()
{
	...
	TCanvas *c1 = new TCanvas("c1", "M_pmpi0.eps", 250, 50, 800, 600);
	...
	ch1->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1a");
	ch2->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1b");
	ch3->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1c");
	ch4->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1d");
	ch5->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1e");
	ch6->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1f");
	ch7->Draw("sqrt((mdc_en[1]+emc_en[0]+emc_en[1])^2-((mdc_px[1]+emc_px[0]+emc_px[1])^2+(mdc_py[1]+emc_py[0]+emc_py[1])^2+(mdc_pz[1]+emc_pz[0]+emc_pz[1])^2))>>h1g");

	h1c->GetXaxis()->SetTitle("M(#bar{p}#pi^{0}) (GeV/c^{2})");
