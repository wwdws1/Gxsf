...
gStyle->SetOptStat(kFALSE);
	...
	ch1->Draw("lambda_chisq>>h1a");
	ch2->Draw("lambda_chisq>>h1b");
	ch3->Draw("lambda_chisq>>h1c");
	//ch1->Draw("lambda_chisq>>h1a", "orig_m2gamma>0.121&&orig_m2gamma<0.149");
	//ch2->Draw("lambda_chisq>>h1b", "orig_m2gamma>0.121&&orig_m2gamma<0.149");
	h1a->GetXaxis()->SetTitle("#chi_{#Lambda Vtxfit}^{2}");
