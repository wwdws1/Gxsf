...
void MLambdaLambdabar()
{
	...
	ch1->Add("E:/Work/IHEPBOX/root/0912MCmix/pi0MC5_NoJpsi.root");
	//ch1->Add("../root/MC_eta.root");

	//TChain *ch2 = new TChain("trkRes");
	//ch2->Add("../../0912MCmix/root/INMC5_pi0.root");
	//ch2->Add("../../0912MCmix/root/Sigma0MC4_pi0.root");

	TChain *ch3 = new TChain("trkRes");
	ch3->Add("E:/Work/IHEPBOX/root/0912data/data5_pi0_NoJpsi.root");
	...
	h1a->Scale(0.7 * h1c->Integral() / h1a->Integral(), "nosw2");
	//h1b->Scale(h1c->Integral() / h1b->Integral());
	h1c->Sumw2();
	h1d->Scale(0.8 * h1c->Integral() / h1d->Integral(), "nosw2");
	...
	lg1->Draw();
	/*
	TArrow *x1 = new TArrow(3.4, 0, 3.4, 160, 0.03, "<");
	x1->SetLineColor(2);
	x1->SetLineWidth(1);
	x1->Draw();
	*/
	TArrow *x1 = new TArrow(3.077, 0, 3.077, 140, 0.03, "<");
	x1->SetLineColor(2);
	x1->SetLineWidth(1);
	x1->Draw();

	TArrow *x2 = new TArrow(3.117, 0, 3.117, 140, 0.03, "<");
	x2->SetLineColor(2);
	x2->SetLineWidth(1);
	x2->Draw();
