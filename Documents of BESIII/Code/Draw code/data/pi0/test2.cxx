{
    ...
    RooRealVar nsig("nsig", "nsig", 60, 0, 300);
    RooRealVar nbkg("nbkg", "nbkg", 60, 0, 300);
    ...
    data.plotOn(mpi0frame, MarkerStyle(8), MarkerSize(0.8), Binning(nbins1));
    sum.plotOn(mpi0frame, RooFit::LineColor(kRed));
    sum.plotOn(mpi0frame, Components("sigpdf"), LineColor(kViolet), LineStyle(kDashed));
    sum.plotOn(mpi0frame, Components("bkgpdf"), LineColor(kBlue), LineStyle(kDashed));
