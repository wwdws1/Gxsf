#include <math.h>
void MgammaLambdaLambdabar()
{
	gStyle->SetOptStat(kFALSE);
	TCanvas *c1 = new TCanvas("c1", "M_gammaLambdaLambdabar.eps", 250, 50, 800, 600);
	...
	h1c->GetXaxis()->SetTitle("M(#gammap#pi^{-}#bar{p}#pi^{+}) (GeV/c^{2})");
	...
	//lg1->AddEntry(h1d, "BKG(#gamma#Lambda#Sigma)", "pl");
	lg1->SetFillColor(0);
	lg1->SetTextFont(42);
	...
	lg1->Draw();
	/*
	TArrow *x1 = new TArrow(3.45, 0, 3.45, 180, 0.03, "<");
	x1->SetLineColor(2);
	x1->SetLineWidth(1);
	x1->Draw();
