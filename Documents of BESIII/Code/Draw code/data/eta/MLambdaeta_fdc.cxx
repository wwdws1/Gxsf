...
void MLambdaeta_fdc()
{
	...
	h1e->GetXaxis()->SetTitle("M(p#pi^{-}#gamma#gamma) (GeV/c^{2})");
	h1e->GetYaxis()->SetTitle(Form("Events/%.5f GeV/c^{2}", (xup1 - xlow1) / nbins1));
