...
void OptChisq4C()
{
	...
	gStyle->SetOptStat(0);
	TFile *f1 = new TFile("E:/Work/IHEPBOX/root/0912MCmix/etaMC4_NoChisq.root");
	//TFile *f1 = new TFile("../root/MC_eta.root");
	TFile *f2 = new TFile("E:/Work/IHEPBOX/root/0912data/data4_eta_NoChisq.root");
	...
	n1->GetXaxis()->CenterTitle();
	n1->GetYaxis()->CenterTitle();
	n1->SetMarkerStyle(8);
	...
	TCanvas *c1 = new TCanvas("c1", "Opt", 250, 50, 800, 600); //Length:Width=7:5, else 3:2
	c1->Divide(1, 1);
	c1->cd(1);
	n1->Draw();
