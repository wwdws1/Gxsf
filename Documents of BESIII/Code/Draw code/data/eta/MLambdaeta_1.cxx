...
void MLambdaeta_1()
{
	...
	TCanvas *c1 = new TCanvas("c1", "M_Lambdaeta.eps", 250, 50, 800, 600);
	...
	ch3->Add("E:/Work/IHEPBOX/root/0912data/data5_eta_fdc.root");

	TChain *ch4 = new TChain("trkRes");
	ch4->Add("E:/Work/IHEPBOX/root/0912MCmix/gammaMC6_pi0.root");
	//ch4->Add("../../0912MCmix/root/gammaMC5_pi0.root");

	TFile *f1 = new TFile("E:/Work/IHEPBOX/root/0912MCmix/dplot.root");
	TH1F *h1e = (TH1F *)f1->Get("h1");

	TFile *f2 = new TFile("E:/Work/IHEPBOX/root/0912MCmix/dplot_eta.root");
	TH1F *h1f = (TH1F *)f2->Get("h1");
	...
	h1e->Sumw2();
	h1e->SetMarkerStyle(8);
	h1e->SetMarkerColor(kBlue);
	h1e->SetMarkerSize(1);
