#include <math.h>
void ChisqLambdaVtxfit()
{
	gStyle->SetOptStat(kFALSE);
	TCanvas *c1 = new TCanvas("c1", "Chisq_LambdaVtxfit.eps");
	...
	ch1->Draw("lambda_chi>>h0a");
	ch2->Draw("lambda_chi>>h0b");
	//ch1->Draw("lambda_chi>>h0a", "orig_m2gamma>0.121&&orig_m2gamma<0.149");
	//ch2->Draw("lambda_chi>>h0b", "orig_m2gamma>0.121&&orig_m2gamma<0.149");
	h0a->GetXaxis()->SetTitle("#chi_{#Lambda Vtxfit}^{2}(GeV/c^{2})");
	...
	*/
	c1->SaveAs("./Chisq_LambdaVtxfit_2.eps");
}