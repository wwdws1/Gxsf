...
void OptMLambda()
{
	...
	gStyle->SetOptStat(0);
	TFile *f1 = new TFile("../root/pi0MC2.root");
	//TFile *f1 = new TFile("../root/MC_eta.root");
	TFile *f2 = new TFile("../../0912data/root/0912data2_pi0.root");
	...
	chain1->SetBranchAddress("orig_mlambda", &chisq1);
	chain2->SetBranchAddress("orig_mlambda", &chisq2);
	...
	n1->SetXTitle(Form("M_{#Lambda} (GeV/c^{2})"));
